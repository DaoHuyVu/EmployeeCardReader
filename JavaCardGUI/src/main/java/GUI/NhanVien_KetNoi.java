...
public class NhanVien_KetNoi extends javax.swing.JFrame {
    ...
    private void ketNoiButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ketNoiButton1ActionPerformed
        // TODO add your handling code here:
     Tao_TheGUI Tao_TheGUI = new Tao_TheGUI(SmartCard); 
     if(SmartCard.connectCard()) {
                Tao_TheGUI.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanVien_KetNoi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhanVien_KetNoi().setVisible(true);
            }
        });
    }
